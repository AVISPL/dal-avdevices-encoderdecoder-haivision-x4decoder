...
public class DecoderConstant {
	...
	public static final String GETTING_DECODER_STATS_ERR = "failed to get device info";
	public static final String GETTING_STREAM_STATS_ERR = "failed to get device IP Address";
